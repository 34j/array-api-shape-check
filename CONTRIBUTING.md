...
array-api-shape-check could always use more documentation, whether as part of the official array-api-shape-check docs, in docstrings, or even on the web in blog posts, articles, and such.
...
2. Clone your fork locally:
   ...
   ```shell
   $ git clone git@github.com:your_name_here/array-api-shape-check.git
   ```
...
[gh-issues]: https://github.com/34j/array-api-shape-check/issues
